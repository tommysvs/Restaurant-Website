    ...
    <div class="sec1-menu">
        ...
        <div class="container-Menu">        
            <div class="container-Tabs">
                ...
                <a class="tabs" href="appetizers-tab.php" style="background-color: khaki;">Appetizers</a>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="grid-menu">
                            <div class="grid-items">
                                ...
                                <p><a class="viewDet" data-toggle="collapse"
                                ...
                                <input type="button" name="add_to_cart" id="<?php echo $row["Product_ID"]; ?>" class="buttonProduct form-control add_to_cart"
                                       value="Add to Cart"/>
                                <br>
                            </div>
                        </div>
